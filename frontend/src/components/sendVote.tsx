...
export default function SendVote(/*{ program }: { program: Program<Counter> | null }*/){
    const [authSerial, setAuthSeial] = useState<string>('');
    ...
    return (
        <>
            ...
            <p></p>
            <input onChange={e=> {setAuthSeial(e.target.value)}} value={authSerial} />
            <p></p>
